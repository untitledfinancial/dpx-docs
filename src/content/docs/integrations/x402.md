...
- [MCP tools](/integrations/mcp) — 76 tools including x402-gated intelligence endpoints
- [Intelligence worker](/api/intelligence-api) — what the macro-stress and FX signals contain
