...
3. If after 5 minutes there's no receipt, contact [partner@untitledfinancial.com](mailto:partner@untitledfinancial.com) with the quoteId — we can trace the redistribution tx manually.
