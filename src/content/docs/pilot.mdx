...
3. If after 5 minutes there's no tx hash, contact us via the [beta access page](/beta) with the quoteId — we can trace the redistribution tx manually.
...
Use the contact form on the [beta access page](/beta) and include:

- Your `quoteId` for any transaction you want traced
- The error or state you're seeing
- The endpoint and parameters you called

Response time during beta: 1–2 business days. For urgent settlement issues during a live pilot, include "URGENT" in the message.
