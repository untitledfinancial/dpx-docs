...
3. If after 5 minutes there's no tx hash, use the contact form on the [beta access page](/beta) with the quoteId.
...
Have questions about the sandbox, want to run a live pilot, or looking to discuss a partnership? Use the contact form on the [beta access page](/beta) — we respond within 1–2 business days.
